...
The following is a set of guidelines for contributing to stats, which are hosted in [my personal account](https://github.com/begarco) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
## Code of Conduct
This project and everyone participating in it is governed by the [Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to [benoit.garcon@outlook.fr](mailto:benoit.garcon@outlook.fr).
